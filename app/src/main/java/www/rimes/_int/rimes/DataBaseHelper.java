...
public class DataBaseHelper extends SQLiteOpenHelper{
        ...
        public String[] getLatLon(String search_key) {

            String [] latlon = null;

            Cursor mcursor = myDataBase.rawQuery("SELECT * FROM city WHERE city_name='" + search_key + "'", null);
    ...
    public Double[] getDekad(String search_key) {
        ...
        if (mcursor != null && mcursor.moveToFirst() ) {
            ...
            latlon = new Double[2];
            latlon [0]= mcursor.getDouble(mcursor.getColumnIndex("lat"));
            latlon[1] = mcursor.getDouble(mcursor.getColumnIndex("lon"));
